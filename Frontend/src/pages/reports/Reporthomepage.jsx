...
const Reporthomepage = () => {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-background)] flex flex-col p-2 md:p-4 transition-colors duration-300">

      <PageHeader
        title="Reports Management"
        description="Generate financial reports and view history."
        icon={ReceiptText}
        actionButtonText="Previous reports"
        actionIcon={History}
        onAction={() => fetchPreviousList()}
